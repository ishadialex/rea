...
import { register, login, forceLogin, validateSession, verifyOtp, resendOtp, forgotPassword, resetPassword, refreshToken, logout } from "../controllers/auth.controller.js";
