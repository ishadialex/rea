  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <div className="overflow-hidden rounded-xl bg-white p-4 shadow-lg dark:bg-gray-dark sm:p-6">
        ...
        <div className="mb-8 flex flex-col items-center gap-6 border-b border-gray-200 pb-8 dark:border-gray-800 sm:flex-row sm:items-start">
          {/* Avatar */}
          <div className="relative">
            <div className="flex h-28 w-28 items-center justify-center overflow-hidden rounded-full bg-gray-100 dark:bg-gray-800">
          ...
          <div className="flex-1 text-center sm:text-left">
            <div className="flex flex-col items-center gap-3 sm:flex-row sm:items-start sm:justify-between">
              <div>
                ...
                <p className="text-body-color dark:text-body-color-dark">{profile.email}</p>
                {profile.occupation && (
                  <p className="mt-1 text-sm font-medium text-primary">{profile.occupation}</p>
                )}
              </div>
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-lg bg-primary/10 px-4 py-2 text-sm font-medium text-primary transition-all hover:bg-primary hover:text-white"
              >
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {profile.bio && (
              <p className="mt-4 max-w-lg text-sm text-body-color dark:text-body-color-dark">
                {profile.bio}
              </p>
            )}
          </div>
