...
const MyReferralPage = () => {
  ...
  const referralLink = "https://alvaradoassociatepartners.com/signup?ref=ADM12345";
  const referralCode = "ADM12345";
  ...
  const handleShare = (platform: string) => {
    ...
    const urls: { [key: string]: string } = {
      ...
      email: `mailto:?subject=${encodedText}&body=Check out this link: ${referralLink}`,
    };
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Stats Cards */}
      <div className="mb-6 grid gap-4 md:mb-8 md:gap-6 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <div className="mb-6 rounded-xl border border-gray-200 bg-white p-4 shadow-lg dark:border-gray-800 dark:bg-gray-dark md:mb-8 md:p-6">
        ...
        <div className="mb-4 flex flex-col gap-3">
          <div className="flex-1 overflow-hidden rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-800 dark:bg-black/20 md:px-4 md:py-3">
            <p className="overflow-x-auto text-xs font-mono text-black scrollbar-thin dark:text-white md:text-sm">
              {referralLink}
            </p>
          </div>
          <button
          ...
          <>
            ...
            <div className="hidden overflow-x-auto md:block">
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-800dark">
                  {referrals.map((referral) => (
                    <tr
                      key={referral.id}
